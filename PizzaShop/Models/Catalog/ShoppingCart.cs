...
namespace PizzaShop.Models.Catalog
{
    public class ShoppingCart
    {
        ...
        public ShoppingCart()
        {
            ...
            if (HttpContext.Current.Session["kosik"] == null)
                HttpContext.Current.Session["kosik"] = this;
        }

        public ShoppingCart My()
        {
            return (ShoppingCart)HttpContext.Current.Session["kosik"];
        }
